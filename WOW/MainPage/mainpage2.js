...
*/
function news(){
	$("#images").children().eq(0).children().eq(0).html('<img src="news1.jpg" />');
	$("#images").children().eq(1).children().eq(0).html('<img src="news2.jpg" />');
	$("#images").children().eq(2).children().eq(0).html('<img src="news3.jpg" />');
	$("#images").children().eq(3).children().eq(0).html('<img src="news4.jpg" />');
...
function picture(){
	$("#images").children().eq(0).children().eq(0).html('<img src="news5.jpg" />');
	$("#images").children().eq(1).children().eq(0).html('<img src="news6.jpg" />');
	$("#images").children().eq(2).children().eq(0).html('<img src="news7.jpg" />');
	$("#images").children().eq(3).children().eq(0).html('<img src="news8.jpg" />');
	$("#images").children().eq(0).children().eq(1).html(
			'<p class="datetext">'
			+'2017-6-7'
			+'</p>'
