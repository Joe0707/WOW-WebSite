        ...
        <div class="menu"></div>
						...
						<div class="gallery">
							<ul class="gallery-pictures">
								<li class="gallery-picture"><a href="#"><img src="img/001.jpg"
									alt="img01"></a></li>
								<li class="gallery-picture"><a href="#"><img src="img/002.jpg"
									alt="img02"></a></li>
								<li class="gallery-picture"><a href="#"><img src="img/003.jpg"
									alt="img03"></a></li>
								<li class="gallery-picture"><a href="#"><img src="img/004.jpg"
									alt="img04"></a></li>
								<li class="gallery-picture"><a href="#"><img src="img/005.jpg"
									alt="img05"></a></li>
							</ul>
			...
			<div class="edit">
				<div id="tab">
					...
					<div id="firstPage" class="show">
						   ...
						   <p>[新闻] <a href="#">2017VGL暴雪游戏音乐会北京站6月开启预定</a></p>
						   <p>[公告] <a href="#">魔兽世界7.2.5职业坐骑上线 一起傲然前行</a></p>
						   <p>[论坛] <a href="#">魔兽世纪职业坐骑攻略 盗贼怎么潜入主城</a></p>
						   <p>[赛事] <a href="#">集合石活动 部落PVP乱斗南海镇VS塔伦米尔 </a></p>
						   <p>[论坛] <a href="#">国服在线修正 抗魔联军任务难度已下降</a></p>
						   <p>[新闻] <a href="#">7.2.5PTR职业改动上线 萨满将成版本之子</a></p>
