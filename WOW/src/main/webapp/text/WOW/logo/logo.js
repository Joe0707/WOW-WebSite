...
$(".menu").html(
		'<img src="/WOW/img/logo12.jpg"/>'
			+'<div class="search">'
			+'<span>搜索</span>'
				+'<input type="text" value="请输入关键字" color:white/>'
			+'</div>'
			+'<div class="title">'
				+'<span><a href="/WOW/MainPage/MainPage.jsp">魔兽世界</a></span>'
				+'<span><a href="#">新闻</a></span>'
				+'<span><a href="#">图片</a></span>'
				+'<span><a href="#">视频</a></span>'
				+'<span><a href="/WOW/download/xiazai.jsp">下载</a></span>'
			+'</div>'		
)
$(".remind").html(
